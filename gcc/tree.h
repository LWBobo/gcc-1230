...
#define OMP_CLAUSE_TILESIMD_EXPR(NODE) \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_TILESIMD), 0)
  
#define OMP_CLAUSE_TASKSIMD_EXPR(NODE) \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_TASKSIMD), 0)
#endif
